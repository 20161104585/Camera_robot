      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
              ...
              <div class="row bg-white has-shadow">
                <!-- Item -->
                  <div class="item d-flex align-items-center" >
                  	<div>
											<label>ip地址：</label><input id="ip" type="text">
											<label>端口号：</label><input id="port" type="text">
											<input id="open" type="button" onclick="buildLink()" value="建立连接">
											<input id="close" type="button" onclick="breakLink()" value="断开连接">
										</div>
          ...
          <section class="dashboard-header">
            <div class="container-fluid">
            	<div class="row" style="margin:0px auto; float: left;">
                <!-- 实时视频画面            -->
                <p>sdfasdfasdfad</p>
              </div>
              <div class="row" style="margin:0px auto; float: right;">
                <!-- 实时视频画面            -->
