                        ...
                        <table class="table table-striped table-hover">
                          <thead>
                            <tr>
                              ...
                              <th>授权用户</th>
                              <th>操作</th>
                              <th><button id="addButton" class="buttonF button5" display="none" onclick="javascrtpt:window.location.href='<%=path %>/robots/addDevice.action?userId=${user.id}'">添加设备</button></th>
                            </tr>
                           </thead>
                          <tbody>
                           <c:forEach var="item" items="${robotList}">
                            <tr>
                              ...
                              <td>${item.username }</td>
                              <td>
                              	<button id="showBut" class="buttonF button5" onclick="javascrtpt:window.location.href='<%=path %>/robots/detailDevice.action?userId=${user.id}&deviceId=${item.deviceid}'">查看</button>
                              	<button id="updateBut" class="buttonF button5" onclick="javascrtpt:window.location.href='<%=path %>/robots/updateDevice.action?userId=${user.id}&deviceId=${item.deviceid}'">修改</button>
                              	<button id="deleteBut" class="buttonF button5" onclick="javascrtpt:window.location.href='<%=path %>/robots/deleteDevice.action?userId=${user.id}&deviceId=${item.deviceid}'">删除</button>
                              </td>         
                            </tr>
                            </c:forEach>
                          </tbody>
