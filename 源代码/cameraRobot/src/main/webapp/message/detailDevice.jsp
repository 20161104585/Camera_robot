                    ...
                    <div class="card-body">
                      <form class="form-horizontal">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="deviceId" value="${robot.deviceid}" disabled="disabled" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                      	<!--2.设备名称-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="deviceName" value="${robot.devicename}" disabled="disabled" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--3.IP地址-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="ipAddress" value="${robot.ipaddress}" disabled="disabled" class="form-control"><small class="help-block-none"></small>
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--4.端口号-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="port" value="${robot.port}" disabled="disabled" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--5.授权用户-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="username" value="${robot.username}" disabled="disabled" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--6.添加时间-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="datetime" id="addTime" value="${robot.addtime}" disabled="disabled" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--7.连接状态-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="state" value="${robot.state}" disabled="disabled" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                          <div class="col-sm-4 offset-sm-3">
                            <button type="button" onclick="javascrtpt:window.location.href='<%=path %>/robots/tables.action?userId=${user.id}'" class="btn btn-secondary">返回</button>
                          </div>
                        </div>
                      </form>
                    </div>
