                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">添加新设备</h3>
                    </div>
                    <div class="card-body">
                      <form action="<%=path %>/robots/addRobot.action?userId=${user.id}" method="post" class="form-horizontal">
                      	<!--1.设备名称-->
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="ipaddress" name="ipaddress" class="form-control"><small class="help-block-none"></small>
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--3.端口号-->
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="datetime" id="addtime" name="addtime" value="<%=now%>" class="form-control">
                            <input type="hidden" id="state" name="state" value="0" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
