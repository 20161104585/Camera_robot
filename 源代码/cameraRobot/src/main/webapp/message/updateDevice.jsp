    ...
    <script type="text/javascript">
	   	$(function(){ 
	        if("${user.type}"==1){
	        	...
	        	document.getElementById("ulMenu").innerHTML= "<li><a href='<%=path %>/signal/index.action?userId=${user.id}'> <i class='icon-home'></i>首页 </a></li> <li class='active'><a href='<%=path %>/robots/tables.action?userId=${user.id}'> <i class='icon-grid'></i>设备信息 </a></li> <li><a href='<%=path %>/videos/charts.action?userId=${user.id}&pageNum=1'> <i class='icon-screen'></i>监控视频 </a></li> <li><a href='<%=path %>/images/forms.action?userId=${user.id}&pageNum=1'> <i class='icon-picture'></i>摄影图片 </a></li> <li><a href='<%=path %>/user/userInfo.action?userId=${user.id}&pageNum=1'> <i class='icon-mail'></i>用户管理 </a></li> <li><a href='<%=path %>/photos/photoInfo.action?userId=${user.id}&pageNum=1'> <i class='icon-screen'></i>摄影作品 </a></li>"; 
              ...
              <div class="row"> 
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form action="<%=path %>/robots/updateRobot.action?userId=${user.id}" id="robotForm" method="post"  enctype="multipart/form-data" class="form-horizontal">
                      	<!--1.设备编号-->
                      	<div class="form-group row">
                          <label class="col-sm-3 form-control-label">设备编号</label>
                          <div class="col-sm-9">
                            <input type="text" id="deviceid" name="deviceid" value="${robot.deviceid}" disabled="disabled" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                      	<!--2.设备名称-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="devicename" name="devicename" value="${robot.devicename}" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--3.IP地址-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="ipaddress" name="ipaddress" value="${robot.ipaddress}" class="form-control"><small class="help-block-none"></small>
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--4.授权用户-->
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">授权用户</label>
                          <div class="col-sm-9">	
                            <select id="users" name="userid" data-placeholder="选择用户" class="form-control mb-3" style="width:200px; display:inline;">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="port"  name="port" value="${robot.port}" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--6.添加时间-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="datetime" id="addtime" name="addtime" value="${robot.addtime}" disabled="disabled" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--7.连接状态-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="state" name="state" value="${robot.state}" disabled="disabled" class="form-control">
                            <input type="hidden" id="userid" name="userid" value="${robot.userid}" disabled="disabled" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                          <div class="col-sm-4 offset-sm-3">
                            <button type="button" onclick="javascrtpt:window.location.href='<%=path %>/robots/tables.action?userId=${user.id}'" class="btn btn-secondary">取消</button>
