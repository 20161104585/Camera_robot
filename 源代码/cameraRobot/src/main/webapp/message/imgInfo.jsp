        ...
        <div class="content-inner">
          ...
          <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">图片信息</li>
            </ul>
          </div>
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">发布摄影图片</h3>
                    </div>
                    <div class="card-body">
                      <form action="<%=path %>/images/imgInfo.action?userId=${user.id}" id="robotForm" method="post"  enctype="multipart/form-data" class="form-horizontal">
                      	<!--1.作品名称-->
                      	<div class="form-group row">
                          <label class="col-sm-3 form-control-label">作品名称</label>
                          <div class="col-sm-9">
                            <input type="text" id="photoname" name="photoname" value="${image.imgname}" disabled="disabled" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--2.作品分类-->
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="introduce" name="introduce" value="" class="form-control"><small class="help-block-none"></small>
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--5.作者-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="username"  name="username" value="${image.username}" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--6.联系方式-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="useremail" name="useremail" value="" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--7.作品展示-->
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
	                          <input type="hidden" id="path" name="path" value="${image.imgaddress}" class="form-control">
	                          <input type="hidden" id="datetime" name="datetime" value="<%=now%>" class="form-control">
	                          <input type="hidden" id="userid" name="userid" value="${image.userid}" class="form-control">
	                          <img alt="图片加载失败" src="/photos/${image.imgname }">
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                          <div class="col-sm-4 offset-sm-3">
                            <button type="button" onclick="javascrtpt:window.location.href='<%=path %>/images/forms.action?userId=${user.id}&pageNum=1'" class="btn btn-secondary">取消</button>
                            <button type="button" onclick="doSubmit()" class="btn btn-primary">发布</button>
                            <button type="button" onclick="javascrtpt:window.location.href='<%=path %>/images/deleteImage.action?userId=${user.id}&imageId=${image.imgid }'" class="btn btn-secondary">删除</button>
                          </div>
                        </div>
                      </form>
                    </div>
