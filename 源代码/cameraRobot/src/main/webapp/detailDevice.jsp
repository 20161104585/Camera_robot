        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
                    ...
                    <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-grid"></i>设备信息 </a>
                        ...
                        <li><a href="updateDevice.html">修改设备</a></li>
                        <li class="active"><a href="detailDevice.html">查看设备</a></li>
                      </ul>
                    </li>
                    ...
                    <div class="card-body">
                      <form class="form-horizontal">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="deviceName" disabled="disabled" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--3.IP地址-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="ipAddress" disabled="disabled" class="form-control"><small class="help-block-none"></small>
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--4.端口号-->
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="port" disabled="disabled" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
                        <!--5.添加时间-->
